...
echo "======================================="
echo "CHRONOFOLD FULL SYSTEM (CANONICAL FINAL)"
echo "======================================="
...
# FORCE CI TRIGGER
# -------------------------------
echo "[7] FORCE CI TRIGGER"
echo "# CI trigger $(date)" >> README.md

# -------------------------------
# SAFE PUSH (NO REJECTION)
# -------------------------------
echo "[8] SYNC + PUSH"
git add .
git commit -m "FULL SYSTEM: SNAP + pipeline + benchmark + CI" || true
